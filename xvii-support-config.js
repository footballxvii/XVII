...
:root { --bg:#080c17; --panel:#11182a; --panel2:#151f36; --text:#f4f7fb; --muted:#9aa7c7; --line:rgba(255,255,255,.12); --accent:#78a6ff; --good:#33d69f; --warn:#f6c85f; --bad:#ff6b6b; }
    * { box-sizing:border-box; }
    ...
    .brand-mark-wrap { display:flex; justify-content:center; margin:0 auto 10px; }
    .brand-mark { width:68px; height:68px; display:block; filter: drop-shadow(0 10px 24px rgba(113,72,255,.18)); border-radius:50%; }
    body.not-started .brand-mark { width:90px; height:90px; }
    body.is-started .brand-mark-wrap { margin-bottom:6px; }
    body.is-started .brand-mark { width:42px; height:42px; opacity:.95; }
    .footer-branding { display:flex; justify-content:center; margin:0 auto 9px; }
    .footer-branding-mark { width:24px; height:24px; display:block; opacity:.92; filter: drop-shadow(0 6px 18px rgba(113,72,255,.15)); border-radius:50%; }
    @media (max-width: 720px) {
      .brand-mark { width:62px; height:62px; }
      body.not-started .brand-mark { width:78px; height:78px; }
      body.is-started .brand-mark { width:38px; height:38px; }
      .footer-branding-mark { width:20px; height:20px; }
    }
