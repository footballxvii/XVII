  ...
  function updateHelpGuide(){
    try{
      ...
      grid.innerHTML=`
        ...
        <div class="xvii-help-section stage13f-owner-help"><h3>Owner mode and boardroom votes</h3><p>At 90+ reputation you can buy into clubs. 5% and 25% stakes give influence, while 51% gives control. Non-controlling owners can vote, but the board may still overrule them.</p><ul><li>Buying from 5% to 25% only charges the extra 20%.</li><li>Board decisions can make owners contribute, but never enough to force financial collapse.</li><li>At 51%, you choose development units and category focus directly.</li><li>Voluntary cash out is permanent for that club: once sold, you cannot buy back into the same club later in the career.</li></ul></div>
